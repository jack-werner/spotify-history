...
data "google_artifact_registry_repository" "spotify-history" {
  location      = var.region
...
resource "google_artifact_registry_repository_iam_member" "job_puller" {
  project    = data.google_artifact_registry_repository.spotify-history.project
  location   = data.google_artifact_registry_repository.spotify-history.location
  repository = data.google_artifact_registry_repository.spotify-history.name
